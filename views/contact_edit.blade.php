								...
								<!---<div class="tab-content">---->
									<div class="tab-pane active show" id="details_content" aria-expanded="true" style="padding: 25px;">
										...
										<div class="row <?= $display; ?>">
											<div class="col-md-4">
												<div class="form-group">
													<label>Phone <?= $i; ?></label>
													<input type="text" name="phone<?= $i; ?>" value="{{ $contact["mobile_phone"] }}" class="form-control">
												</div>
											</div>
                                                                                        <div class="col-md-4">
												<div class="form-group">
													<label>Phone <?= $i; ?></label>
													<input type="text" name="phone<?= $i; ?>" value="{{ $contact["home_phone"] }}" class="form-control">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Address <?= $i; ?></label>
													<input type="text" name="address<?= $i; ?>" value="{{ $contact["street"] }}" class="form-control">
												</div>
											</div>
										</div>
										<?php endfor; ?>
									...
									<div class="row ">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>State </label>
													<input type="text" name="state<?= $i; ?>" value="{{ $contact["state"] }}" class="form-control">
												</div>
											</div>
									...
									<div class="row ">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" name="spousefname" value="{{ $contact["spouse_first"] }}" class="form-control">
												</div>
											</div>
                                                                                        <div class="col-md-4">
												<div class="form-group">
													<label>Spouse Last Name </label>
													<input type="text" name="spouselname" value="{{ $contact["spouse_last"] }}" class="form-control">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Lead Source (Google, Facebook, Direct) </label>
													<input type="text" name="leadsource" value="{{ $contact["lead_source"] }}" class="form-control">
												</div>
											</div>
										...
										<div class="row ">
											<div class="col-md-12">
												<div class="form-group">
													<label>Tags </label>
													<input type="text" name="spousename" class="form-control" value="{{ $contact["tag"] }}" placeholder="Like: Sale, Bill, Year">
												</div>
											</div>
										</div>
										<div class="row ">
										...
										<!--<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Street</label>
													<input class="form-control" type="text" name="street" value="{{ $contact["street"] }}">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>State</label>
													<input class="form-control" type="text" name="state" value="{{ $contact["state"] }}">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>ZIP</label>
													<input class="form-control" type="text" name="zip" value="{{ $contact["zip"] }}">
												</div>
											</div>
										</div>
										<br>
															...
															<div class="m-scrollable" data-scrollable="true" data-height="380" data-mobile-height="300">
																...
																<div class="m-timeline-2">
																	<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
																		...
																		@if($followupData['followup_type'] == 'Call')
																		...
																		@if($followupData['followup_type'] == 'Appointment')
																		...
																		@endif
																		@if($followupData['followup_type']  == 'Task')
																		<div class="m-timeline-2__item m--margin-top-30">
																		...
																		@endif
																		<!-- @if($activityData['action_type'] == 'sms')
																		<div class="m-timeline-2__item m--margin-top-30">
															...
															<div class="m-scrollable" data-scrollable="true" data-height="380" data-mobile-height="300">
																...
																<div class="m-timeline-2">
																	<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
																		...
																		@if($activityData['action_type'] == 'call')
																		<div class="m-timeline-2__item">
																			<span class="m-timeline-2__item-time">02:00<br> Mon</span>
																			<div class="m-timeline-2__item-cricle">
																				<i class="fa fa-genderless m--font-danger"></i>
																		...
																		@if($activityData['action_type'] == 'website')
																		<div class="m-timeline-2__item m--margin-top-30">
																			<span class="m-timeline-2__item-time">05:13<br> Tue</span>
																			<div class="m-timeline-2__item-cricle">
																				<i class="fa fa-genderless m--font-success"></i>
																		...
																		@endif
																		@if($activityData['action_type'] == 'email')
																		<div class="m-timeline-2__item m--margin-top-30">
																			<span class="m-timeline-2__item-time">11:50<br> Wed</span>
																			<div class="m-timeline-2__item-cricle">
																				<i class="fa fa-genderless m--font-brand"></i>
								...
								<div class="m-portlet  m-portlet--full-height " style="margin-top: 60px;display:none;">
										<div class="m-portlet__body mt-0">
												...
												<div class="row">
													...
													@if($previous !='')
													<div class="col-md-6">
														<a href="https://portal.theoffercompany.com/contact_edit.php?id={{ $previous }}" class="btn btn-primary" style="width: 160px;">Previous</a>
													</div>
													@else
													<div class="col-md-6">
													...
													@if($next !='')
													<div class="col-md-6">
														<a href="https://portal.theoffercompany.com/contact_edit.php?id={{ $next }}" class="btn btn-primary" style="width: 160px;">Next</a>
													</div>
													@else
													<div class="col-md-6">
