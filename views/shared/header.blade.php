				...
				<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
					<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/index.php" class="m-menu__link @if ( $page === "index" ) active @endif">
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/#" class="m-menu__link @if ( $page === "listings" ) active @endif">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									Messages
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/#" class="m-menu__link @if ( $page === "contacts" ) active @endif">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Schedule
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/contacts.php" class="m-menu__link @if ( $page === "contacts" ) active @endif">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Leads
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/listings.php" class="m-menu__link @if ( $page === "contacts" ) active @endif">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Transactions
								</span>
						...
						<?php else: ?>
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/login.php" class="m-menu__link @if ( $page === "login" ) active @endif">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									Login
								</span>
