	...
	<body  class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside-left--fixed m-aside-left--offcanvas m-aside-left--minimize m-brand--minimize m-footer--push m-aside--offcanvas-default"  >
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-portlet__body" style="width: 100%;">
					...
					<form action="/api/update_listing_images.php" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" name="id" value="{!! urlencode( $listing["id"] ) !!}">

						<table class="m-datatable__table" cellspacing="10" cellpadding="15">
							<tbody>
								<tr>
									<td>Hero</td>
									<td><img src="{!! $listing["hero-image"] !!}" class="display_image" data-name="hero-image"></td>
									<td><input type="file" name="hero-image"></td>
								</tr>
								<tr>
									<td>Description</td>
									<td><img src="{!! $listing["desc_image"] !!}" class="display_image" data-name="desc_image"></td>
									<td><input type="file" name="desc_image"></td>
								</tr>
								<tr>
									<td>Amenities</td>
									<td><img src="{!! $listing["amenities_image"] !!}" class="display_image" data-name="amenities_image"></td>
									<td><input type="file" name="amenities_image"></td>
								</tr>
								<tr>
									<td>Gallery 1</td>
									<td><img src="{!! $listing["gallery_image_1"] !!}" class="display_image" data- name="gallery_image_1"></td>
									<td>
								...
								<tr>
									<td>Gallery 2</td>
									<td><img src="{!! $listing["gallery_image_2"] !!}" class="display_image" data-name="gallery_image_2"></td>
									<td>
								...
								<tr>
									<td>Gallery 3</td>
									<td><img src="{!! $listing["gallery_image_3"] !!}" class="display_image" data-name="gallery_image_3"></td>
									<td>
								...
								<tr>
									<td>Gallery 4</td>
									<td><img src="{!! $listing["gallery_image_4"] !!}" class="display_image" data-name="gallery_image_4"></td>
									<td>
		...
		<script>
			...
			$( 'input[type="file"]' ).change( function() {
				...
				$.ajax({
					type: "POST",
					url: "{!! FRONTEND_BASE_URL !!}/api/propertyImageUpload.php?id=" + encodeURIComponent( {!! $listing["id"] !!} ) + "&name=" + encodeURIComponent( name ),
					cache: false,
					contentType: false,
					processData: false,
					data: form_data,
