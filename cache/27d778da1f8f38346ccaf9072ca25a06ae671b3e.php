				...
				<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
					<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/index.php" class="m-menu__link <?php if( $page === "index" ): ?> active <?php endif; ?>">
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/#" class="m-menu__link <?php if( $page === "listings" ): ?> active <?php endif; ?>">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									Messages
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/#" class="m-menu__link <?php if( $page === "contacts" ): ?> active <?php endif; ?>">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Schedule
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/contacts.php" class="m-menu__link <?php if( $page === "contacts" ): ?> active <?php endif; ?>">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Leads
								</span>
						...
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/listings.php" class="m-menu__link <?php if( $page === "contacts" ): ?> active <?php endif; ?>">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									My Transactions
								</span>
						...
						<?php else: ?>
						<li class="m-menu__item m-menu__item--submenu m-menu__item--rel">
							<a href="/login.php" class="m-menu__link <?php if( $page === "login" ): ?> active <?php endif; ?>">
								<span class="m-menu__item-here"></span>
								<span class="m-menu__link-text">
									Login
								</span>
										...
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand" role="tablist">
													...
													<li class="nav-item m-tabs__item">
														<a class="nav-link m-tabs__link" data-toggle="tab" href="#topbar_notifications_logs1" role="tab">
															Compliance Alert
														</a>
													</li>
													<li class="nav-item m-tabs__item">
														<a class="nav-link m-tabs__link" data-toggle="tab" href="#topbar_notifications_logs2" role="tab">
															Mail Messages
														</a>
													</li>
												</ul>
												<div class="tab-content">
													...
													<div class="tab-pane" id="topbar_notifications_logs1" role="tabpanel">
														<div class="m-stack m-stack--ver m-stack--general" style="min-height: 180px;">
															<div class="m-stack__item m-stack__item--center m-stack__item--middle">
																<span class="">
																	All caught up!
													...
													<div class="tab-pane" id="topbar_notifications_logs2" role="tabpanel">
														<div class="m-stack m-stack--ver m-stack--general" style="min-height: 180px;">
															<div class="m-stack__item m-stack__item--center m-stack__item--middle">
																<span class="">
																	All caught up!
											...
											<div class="m-dropdown__content">
												<div class="m-scrollable" data-scrollable="false" data-max-height="380" data-mobile-max-height="200">
													<div class="m-nav-grid m-nav-grid--skin-light">
														...
														<div style="display:none;" class="m-nav-grid__row">
															<a href="#" class="m-nav-grid__item">
										...
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li style="display:none;" class="m-nav__separator m-nav__separator--fit"></li>
													<li style="display:none;" class="m-nav__item">
														<a href="profile.html" class="m-nav__link">
