										...
										<tbody>
											...
											<?php else: ?>
												...
												<?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														<td style="width: 20%">
															<div class="row"><?php echo e($contact["name_first"]); ?></div>
															<div class="row"><?php echo e($contact["name_last"]); ?></div>
														</td>
														<td style="width: 20%">
															<div class="row nowrap"><?php echo e($contact["street"]); ?></div>
															<div class="row nowrap"><?php echo e($contact["city"]); ?></div>
															<div class="row nowrap"><?php echo e($contact["state"]); ?></div>
															<div class="row nowrap"><?php echo e($contact["zip"]); ?></div>
														</td>
														<td style="width: 10%"><div class="row nowrap"><?php echo e($contact["mobile_phone"]); ?></div></td>
														<td style="width: 10%"><div class="row nowrap"><?php echo e($contact["email"]); ?></div></td>
														<td style="width: 10%">
															<div class="row"><?php echo e($contact["pipeline_status"]["name"]); ?></div>
														</td>
														<td style="width: 10%">
															<div class="row"><?php echo e($contact["transaction_type"]["name"]); ?></div>
														</td>
														<td style="width: 10%">
															<div class="row"><?php echo e($contact["contact_type"]["name"]); ?></div>
														</td>
														
														
														
														<td style="width: 10%">
															<a class="btn btn-primary" href="/contact_edit.php?id=<?php echo e(urlencode( $contact["id"] )); ?>">Edit</a>
														</td>
													</tr>
