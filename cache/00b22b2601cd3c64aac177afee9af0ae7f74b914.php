...
<html lang="en" >
				...
				<div>
					...
					<div class="m-subheader header">
						<div class="d-flex align-items-center">
							...
							<div>
								<button class="btn btn-primary" id="new_contact_row_button">New Contact</button>
							</div>
						</div>
					</div>
	...
	<script>
		...
		const is_empty = <?php echo e($is_empty); ?>;
		...
		// create a new contact row by default
		//createNewContactRow();

		// if we don't have any contacts, remove the template contact
		if ( is_empty ) {
			items_container.find( ".item" ).first().remove();
		}
