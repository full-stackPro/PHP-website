				...
				<div class="m-portlet__body" style="width: 100%;">
					...
					<form action="/api/update_listing.php" method="post">
						...
						<div class="listing" style="margin-top: 10px;font-size: 20px;">
								...
								<div class="input">
									<?php echo e($listing["offer_create_dt"]); ?>
						...
						<!--<div class="listing">
							...
							<div class="item">
								...
								<div class="input">
									<input id="firstname" type="text" name="firstname" value="<?php echo $listing["firstname"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="lastname">Lastname</label>
								<div class="input">
									<input id="lastname" type="text" name="lastname" value="<?php echo $listing["lastname"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="email">Email</label>
								<div class="input">
									<input id="email" type="text" name="email" value="<?php echo $listing["email"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="phone">Phone</label>
								<div class="input">
									<input id="phone" type="text" name="phone" value="<?php echo $listing["phone"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="street">Street</label>
								<div class="input">
									<input id="street" type="text" name="street" value="<?php echo $listing["street"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="city">City</label>
								<div class="input">
									<input id="city" type="text" name="city" value="<?php echo $listing["city"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="state">State</label>
								<div class="input">
									<input id="state" type="text" name="state" value="<?php echo $listing["state"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="zip">Zip</label>
								<div class="input">
									<input id="zip" type="text" name="zip" value="<?php echo $listing["zip"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
                                                  </div>
                                                  <div class="listing">
							...
							<div class="item">
								...
								<div class="input">
									<input id="floors" type="text" name="floors" value="<?php echo $listing["floors"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="square-feet">Square Feet</label>
								<div class="input">
									<input id="square-feet" type="text" name="square-feet" value="<?php echo $listing["square-feet"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="bathrooms">Bathrooms</label>
								<div class="input">
									<input id="bathrooms" type="text" name="bathrooms" value="<?php echo $listing["bathrooms"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="bedrooms">Bedrooms</label>
								<div class="input">
									<input id="bedrooms" type="text" name="bedrooms" value="<?php echo $listing["bedrooms"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="garage-space">Garage-space</label>
								<div class="input">
									<input id="garage-space" type="text" name="garage-space" value="<?php echo $listing["garage-space"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="property-desc">Property Description</label>
								<div class="input">
									<input id="property-desc" type="text" name="property-desc" value="<?php echo $listing["property-desc"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
                                                  </div>-->
							...
							<div class="item">
								...
								<div class="input">
									<input id="avm_date" type="text" name="avm_date" value="<?php echo $listing["avm_date"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
                             <div class="item"></div>                           
							<div class="item">
								...
								<div class="input">
									<input id="permitted_additions" type="text" name="permitted_additions" value="<?php echo $listing["permitted_additions"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="unpermitted_additions">Unpermitted Additions</label>
								<div class="input">
									<input id="unpermitted_additions" type="text" name="unpermitted_additions" value="<?php echo $listing["unpermitted_additions"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="features_list">Features List</label>
								<div class="input">
									<textarea id="features_list" rows="5" cols="30" name="features_list" class="spinner_input"><?php echo $listing["features_list"]; ?></textarea><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="has_pool">Has Pool</label>
								<div class="input">
									<input id="has_pool" type="text" name="has_pool" value="<?php echo $listing["has_pool"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="kitchen_condition">Kitchen Condition</label>
								<div class="input">
									<input id="kitchen_condition" type="text" name="kitchen_condition" value="<?php echo $listing["kitchen_condition"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="kitchen_counters">Kitchen Counters</label>
								<div class="input">
									<input id="kitchen_counters" type="text" name="kitchen_counters" value="<?php echo $listing["kitchen_counters"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="kitchen_appiances">Kitchen Appliances</label>
								<div class="input">
									<input id="kitchen_appiances" type="text" name="kitchen_appiances" value="<?php echo $listing["kitchen_appiances"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="flooring_type">Flooring Type</label>
								<div class="input">
									<input id="flooring_type" type="text" name="flooring_type" value="<?php echo $listing["flooring_type"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="masterbath_condition">Masterbath Condition</label>
								<div class="input">
									<input id="masterbath_condition" type="text" name="masterbath_condition" value="<?php echo $listing["masterbath_condition"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="flooring_condition">Flooring Condition</label>
								<div class="input">
									<input id="flooring_condition" type="text" name="flooring_condition" value="<?php echo $listing["flooring_condition"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="interior-paint_condition">Interior-paint Condition</label>
								<div class="input">
									<input id="interior-paint_condition" type="text" name="interior-paint_condition" value="<?php echo $listing["interior-paint_condition"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="backyard_condition">Backyard Condition</label>
								<div class="input">
									<input id="backyard_condition" type="text" name="backyard_condition" value="<?php echo $listing["backyard_condition"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="has_renovated">Has Renovated</label>
								<div class="input">
									<input id="has_renovated" type="text" name="has_renovated" value="<?php echo $listing["has_renovated"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="sales_timeline">Sales Timeline</label>
								<div class="input">
									<input id="sales_timeline" type="text" name="sales_timeline" value="<?php echo $listing["sales_timeline"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								...
								<div class="input">
                                                                        <select id="structure-mech_issues" name="structure-mech_issues" class="spinner_input">
                                                                          <option value="<?php echo $listing["structure-mech_issues"]; ?>">No</option>
                                                                          <option value="<?php echo $listing["structure-mech_issues"]; ?>">Yes</option>
                                                                        </select>
							...
							<div class="item">
								...
								<div class="input">
									<input id="what_else_home" type="text" name="what_else_home" value="<?php echo $listing["what_else_home"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="selling_reason">Selling Reason</label>
								<div class="input">
									<input id="selling_reason" type="text" name="selling_reason" value="<?php echo $listing["selling_reason"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="heard_about_us">Heard About Us</label>
								<div class="input">
									<input id="heard_about_us" type="text" name="heard_about_us" value="<?php echo $listing["heard_about_us"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="source_url">Source Url</label>
								<div class="input">
									<input id="source_url" type="text" name="source_url" value="<?php echo $listing["source_url"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div style="display:none;" class="item">
								<label for="estimate-token">Estimate-token</label>
								<div class="input">
									<?php echo e($listing["estimate-token"]); ?>
							...
							<div class="item">
								...
								<div class="input">
									<input id="listing-url" type="text" name="listing-url" value="<?php echo $listing["listing-url"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="average-high">Average-high</label>
								<div class="input">
									<input id="average-high" type="text" name="average-high" value="<?php echo $listing["average-high"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="average-low">Average-low</label>
								<div class="input">
									<input id="average-low" type="text" name="average-low" value="<?php echo $listing["average-low"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								...
								<div class="input">
									<select id="show_countdown" name="show_countdown" class="spinner_input">
                                                                          <option value="<?php echo $listing["show_countdown"]; ?>">No</option>
                                                                          <option value="<?php echo $listing["show_countdown"]; ?>">Yes</option>
                                                                        </select>
                                                                        <span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								...
								<div class="input">
									<input id="walkthrough_date" type="text" name="walkthrough_date" value="<?php echo $listing["walkthrough_date"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
							<div class="item">
								<label for="walkthrough_time">Walkthrough Time</label>
								<div class="input">
									<input id="walkthrough_time" type="text" name="walkthrough_time" value="<?php echo $listing["walkthrough_time"]; ?>" class="spinner_input"><span class="spinner no_overlay"></span>
								</div>
							</div>
						</div>
